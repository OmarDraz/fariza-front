...
const Home: NextPage = () => {
  return (
    <div dir="rtl">
      ...
      <div style={{height: '100vh', width: '100%', top: 0, display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1, backgroundImage: `url("/Pattern.png"), linear-gradient(to left, #2da8eb, #2c9bd7, #2b8ec3, #2b81af, #2a749c)` }}>
        <div className="row ">
          <div className={`col-md-6 col-xs-12 ${styles.bannerImg}`}>
            <svg className={`${styles.bannerImgSize}`} viewBox="0 0 639 323" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M629.3 322.7H9C4 322.7 0 318.7 0 313.7C0 308.7 4 304.7 9 304.7H629.3C634.3 304.7 638.3 308.7 638.3 313.7C638.3 318.7 634.3 322.7 629.3 322.7Z" fill="white" fill-opacity="0.7"/>
            ...
            <path d="M518.756 222.328V47.7281L212.756 47.7281L212.756 222.328L518.756 222.328Z" fill="#F6F9FD"/>
            ...
            <path d="M518.756 222.328V47.7281L212.756 47.7281L212.756 222.328L518.756 222.328Z" stroke="#1F3969" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M352.3 241.4H379.2" stroke="#1F3969" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M429.8 166.3H240.7C236.3 166.3 232.7 162.7 232.7 158.3V10.1C232.7 5.70001 236.3 2.10001 240.7 2.10001H429.8C434.2 2.10001 437.8 5.70001 437.8 10.1V158.4C437.8 162.8 434.2 166.3 429.8 166.3Z" fill="#2D425E"/>
            ...
            <path d="M437.8 25.3H232.7V10C232.7 5.6 236.3 2 240.7 2H429.8C434.2 2 437.8 5.6 437.8 10V25.3Z" stroke="#1F3969" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M429.8 166.3H240.7C236.3 166.3 232.7 162.7 232.7 158.3V10.1C232.7 5.70001 236.3 2.10001 240.7 2.10001H429.8C434.2 2.10001 437.8 5.70001 437.8 10.1V158.4C437.8 162.8 434.2 166.3 429.8 166.3Z" stroke="#1F3969" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <path d="M536.5 194.7H420.5C416.1 194.7 412.5 191.1 412.5 186.7V63.8C412.5 59.4 416.1 55.8 420.5 55.8H536.5C540.9 55.8 544.5 59.4 544.5 63.8V186.7C544.5 191.2 540.9 194.7 536.5 194.7Z" fill="#2AA1FF"/>
            ...
            <path d="M252.8 17.7C255.009 17.7 256.8 15.9091 256.8 13.7C256.8 11.4908 255.009 9.69998 252.8 9.69998C250.591 9.69998 248.8 11.4908 248.8 13.7C248.8 15.9091 250.591 17.7 252.8 17.7Z" fill="#1F3969"/>
            <path d="M266.7 17.7C268.909 17.7 270.7 15.9091 270.7 13.7C270.7 11.4908 268.909 9.69998 266.7 9.69998C264.491 9.69998 262.7 11.4908 262.7 13.7C262.7 15.9091 264.491 17.7 266.7 17.7Z" fill="#1F3969"/>
            <path d="M280.6 17.7C282.809 17.7 284.6 15.9091 284.6 13.7C284.6 11.4908 282.809 9.69998 280.6 9.69998C278.391 9.69998 276.6 11.4908 276.6 13.7C276.6 15.9091 278.391 17.7 280.6 17.7Z" fill="#1F3969"/>
            ...
            <path d="M594.839 215.241L585.097 214.181L577.248 286.353L586.991 287.413L594.839 215.241Z" fill="#FF5252"/>
            <path d="M594.839 215.241L585.097 214.181L577.248 286.353L586.991 287.413L594.839 215.241Z" stroke="#1F3969" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M594.911 215.258L585.169 214.199L584.369 221.555L594.111 222.614L594.911 215.258Z" fill="#2D425E"/>
            <path d="M594.911 215.258L585.169 214.199L584.369 221.555L594.111 222.614L594.911 215.258Z" stroke="#1F3969" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M600.9 311H561.6L555.2 250.8H607.3L600.9 311Z" fill="#6567C3"/>
            <path d="M555.2 250.8L555.3 251.9H595L588.7 311H600.9L607.3 250.8H555.2Z" fill="#6567C3"/>
          ...
          <div className={`col-md-6 col-xs-12 ${styles.slogan}`} style={{ color: 'white' }}>
            <h1 className={styles.bannerTitle}>انضم الان</h1>
            <p className={styles.bannerSentence}>لاكبر مجتمع للمبرمجين العرب وشارك المشاكل والحلول</p>
            <div>
              <button className={styles.whiteBtn}>انضم الان</button>
              <button className={styles.transparentBtn}>تصفح الاسئلة</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={styles.aboutSection}>
        <Image src="/11 1.jpg" width="493px" height="457px" className={styles.home} />
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'right' }}>
          <h3 className={styles.sectionTitle}>حول فارزة</h3>
          <p className={styles.aboutParagraph}>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.
إذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه
      ...
      <div style={{ margin: 50 }}>
        <h3 className={styles.sectionTitle}>المطورون</h3>
        <Swiper
        breakpoints={{
      ...
      >
        <SwiperSlide style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <Image src="/11 1.jpg" width="100px" height="100px" className={styles.avatar} />
          <h5>عمر نادر</h5>
          <p>مصمم UI/UX ومطور React</p>
        </SwiperSlide>
        <SwiperSlide style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
            <Image src="/11 1.jpg" width="100px" height="100px" className={styles.avatar} />
          <h5>عمر نادر</h5>
